...
melody_rnn_generate --config=attention_rnn --run_dir=%MODEL_CHECKPOINTS_DIR% --output_dir=%GENERATED_OUTPUT_DIR% --num_outputs=3 --num_steps=1024 --hparams="batch_size=64,rnn_layer_sizes=[64,64]" --primer_midi="./midi_files/Blues_for_allice_head.midi"
